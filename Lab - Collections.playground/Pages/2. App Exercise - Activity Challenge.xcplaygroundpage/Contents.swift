 ...
 */
var walking: [String] = ["Walk two miles", "Walk to a different state"]
var running: [String] = ["Run five miles", "Run accross the United States"]
/*:
...
if committed.isEmpty {
    ...
    print("The challenge you have chosen is swimming the atlantic ocean.")
} else {
